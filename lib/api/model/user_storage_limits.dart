...
class UserStorageLimits {
  ...
  static const _mobileMaxBalances = 36;
  ...
  /// Returns the maximum number of balances for the current user.
  /// Defaults to [_mobileMaxBalances] if the platform is mobile.
  /// Defaults to [_webMaxBalances] if the platform is web.
  /// Defaults to [_webPremiumMaxBalances] if the platform is web and the user is premium.
  static int get maxBalances {
    if (kIsWeb) {
      if (FirebasePortfolioApiService.isPremium) {
        return _webPremiumMaxBalances;
      }
      return _webMaxBalances;
    }
    return _mobileMaxBalances;
  }
